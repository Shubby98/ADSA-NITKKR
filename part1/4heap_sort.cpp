...
void max_heap_sort( Maxheap heap )
{
    cout<<"Sorting Element in descending order"<<endl;
    while(!heap.isEmpty()){
        cout<<heap.removeMax()<<" ";
    }
    cout<<endl;
...
void min_heap_sort(Minheap heap)
{
    cout << "Sorting Element in ascending order" << endl;
    while (!heap.isEmpty())
    {
        cout << heap.removeMin() << " ";
    }
...
int main()
{
    ...
    max_heap_sort(maxaheap);
    min_heap_sort(miniheap);
